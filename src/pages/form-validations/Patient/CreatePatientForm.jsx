...
export default class CreatePatientForm extends SampleBase {
  alertDlg;
  tab;
  ticketDetailGrid;
  pass_gender3;
  ...
  today = new Date();
  selectedTrain;
  dlgTarget = document.querySelector(
      ...
      if (name1.value !== "") {
        ...
        let gender =
          i === 1
            ...
            : this.pass_gender3.value;
        let berth =
          i === 1
            ? this.pass_berth1.value
            : i === 2
            ? this.pass_berth2.value
            : this.pass_berth3.value;
  ...
  content0() {
    return (
      <div id="booking">
        <div className="wizard-title">Enter Patient Personal Details</div>
    ...
    return (
      <div id="selectTrain">
        ...
        <GridComponent
          ...
          created={this.availableTrainGridcreated.bind(this)}
        >
          <ColumnsDirective>
            <ColumnDirective
              field="TrainNo"
    ...
    return (
      <div id="confirm">
        ...
        <GridComponent
          ...
          width="100%"
          created={this.ticketDetailGridcreated.bind(this)}
        >
          <ColumnsDirective>
            <ColumnDirective
              field="TrainNo"
